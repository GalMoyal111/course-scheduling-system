...
function UploadPage() {
  ...
  const performDeleteLesson = async () => {
    ...
    try {
      ...
      console.error(err);
      showError(
        "Failed to delete lesson(s). Reverting UI and check console for details.",
      );
    ...
    <div>
        ...
        <div className="left">
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <input
              ...
              placeholder="Search by course id, name or type"
      ...
      {isUploading && (
        <div className="uploading-overlay">
          ...
          <h2 style={{ color: "white", marginTop: "20px", fontWeight: "600" }}>
            Processing file...
          </h2>
          <p style={{ color: "#e2e8f0", marginTop: "8px" }}>
            Please wait, processing may take a few seconds.
          </p>
        </div>
      )}
...
function LessonUploadSummaryModal({ isOpen, summary, onClose }) {
  ...
  return (
    ...
    >
      ...
      {renderIssueSection(
        "Course Name Mismatches",
        summary.mismatchedCourseNames,
      )}
